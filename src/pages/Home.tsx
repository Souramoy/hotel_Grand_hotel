            ...
            {[
              {
                name: "Sarah Johnson",
                rating: 5,
                comment: "Absolutely stunning hotel with incredible service. The luxury suite exceeded all expectations!"
              },
              {
                name: "Michael Chen",
                rating: 5,
                comment: "The restaurant is phenomenal and the staff made our anniversary truly special. Highly recommend!"
              },
              {
                name: "Emma Williams",
                rating: 5,
                comment: "Beautiful location, clean rooms, and the attention to detail is remarkable. Will definitely return!"
              }
